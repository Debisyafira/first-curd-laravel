    ...
    <div class="p-5">
        <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mb-2">
                <label>Nama*</label>
                <input name="nama" type="text" class="form-control" placeholder="Masukkan nama" value="">
                <small id="emailHelp" class="form-text">Masukkan nama lengkap anda</small>
            </div>
            <div class="form-group mb-2">
                <label>Email*</label>
                <input name="email" type="email" class="form-control" placeholder="Masukkan email" value="">
            ...
            <div class="form-group mb-2">
                <label>No.hp</label>
                <input name="nohp" type="number" class="form-control" placeholder="Masukkan ">
                <small id="text" class="form-text"></small>
            </div>
